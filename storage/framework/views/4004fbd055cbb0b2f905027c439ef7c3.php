...
unset($__errorArgs, $__bag); ?>" id="activity_type" name="activity_type" required>
                        ...
                        <?php $__currentLoopData = $activityTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('activity_type') == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="activity_name" name="activity_name" value="<?php echo e(old('activity_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="end_time" name="end_time" value="<?php echo e(old('end_time')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                        ...
                        <?php $__currentLoopData = $statusList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('status') == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/activities/create.blade.php ENDPATH**/ ?>